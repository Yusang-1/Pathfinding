...
namespace Assets.Scripts.CreateMap
{
    public class MapdataJsonConverter
    {
        ...
        public CreateMapManager.MapData[] GetPersonalSavedMaps()
        {
            if (!Directory.Exists(personalMapFilePath))
            {
                Directory.CreateDirectory(personalMapFilePath);
            ...
            var results = new CreateMapManager.MapData[files.Length];
        ...
        public CreateMapManager.MapData[] GetOfficialSavedMaps()
        {
